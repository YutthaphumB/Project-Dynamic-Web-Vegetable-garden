...
<body>
    <div>
        ...
        <br>
        <h2 align="center">โปรแกรมจัดข้อมูลผู้จัดทำ</h2>
        <br>
        
        <div class="row justify-content-lg-center">
            <div class="d-flex justify-content-center">
                <a href="addCre.php"><button type="button" class="btn btn-success">เพิ่มข้อมูล</button> </a>
            </div>
        </div>
        <br>
        <div class="container">
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td><?php echo $sql["pre"] ?></td>
                                    <td><?php echo $sql["name"] ?></td>
                                    <td><?php echo $sql["lastname"] ?></td>
                                    <td><?php echo $sql["branch"] ?></td>
                                    <td><?php echo $sql["group"] ?></td>
                                    <td><?php echo $sql["university"] ?></td>
                                    <td><img src="<?php echo $sql["img"] ?>" class="img-thumbnail" width="150px"> <br></td>
                                    
                                    <td><a href='delCre.php?id=<?php echo $sql["id"] ?>' onclick="return confirm('คุณต้องการลบข้อมูลที่เลือก')"><button type="button" class="btn btn-danger">Delete</button></a></td>
                                    <td><a href="updateCre.php?id=<?php echo $sql["id"]; ?>"><button type="button" class="btn btn-warning">Update</button></a></td>
                                </tr>
                            <?php } ?>
