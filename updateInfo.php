        ...
        <div class="container">
                ...
                <div class="col-9">
                    <form method="POST" enctype="multipart/form-data" style="background-color: #F8F8FF;">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="id" value=<?php echo $data['title'] ?>>
                        </div><br>
                        <div class="form-group">
                            <label for="formGroupExampleInput2">หัวข้อ</label>
                            <input type="text" class="form-control" name="pre" value=<?php echo $data['head'] ?>>
                        </div><br>
                        <div class="form-group">
                            <label for="formGroupExampleInput2">ข้อมูล</label>
                            <textarea type="text" class="form-control" name="name" rows="5">"<?php echo $data['info'] ?>"</textarea>
                        </div>
                        <br>
            ...
            <div class="row justify-content-md-center">
                <div class="col-md-auto">
                    <a href="editInfo.php"><button type="button" class="btn btn-primary">กลับสู่หน้าหลัก</button> </a>
                </div>
            </div>
        </div>
